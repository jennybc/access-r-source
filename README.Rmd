...
Search for `levels<-` in `$R HOME/src/main/names.c` and we find [this line](`$R HOME/src/main/names.c`):
...
https://github.com/hadley/dplyr/blob/2a3d526a85f484f75218807e0e5feed2d65e2c13/src/bind.cpp#L7-L119).
